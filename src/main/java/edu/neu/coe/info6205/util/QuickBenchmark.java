...
public class QuickBenchmark {
    public static void main(String[] args) {
        for (int n = 10000; n <= 256000; n = n * 2) {
            ...
            BaseHelper<Integer> helper = new InstrumentedHelper<>("QuickSortHelper", config);
            QuickSort<Integer> quick = new QuickSort_DualPivot<>(helper);
            Consumer<Integer[]> consumer = RanArr -> quick.sort(RanArr);
            Benchmark_Timer<Integer[]> BT = new Benchmark_Timer<>("QuickSort Time Test " + n + " elements", consumer);
            int finalN = n;
        ...
        for (int n = 10000; n <= 256000; n = n * 2)
        {
            ...
            System.out.println("QuickSort Time Test "+n+" elements : " + randTime);
        }
    }
}
